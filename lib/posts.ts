export type Post = {
  ...
  author: string;
  date: string;      // ISO string: "2025-10-30"
  tags: string[];
  summary: string;   // short AI-style summary
};

export const posts: Post[] = [
  {
    slug: "vr-physiotherapy-future-rehab",
    title: "How Virtual Reality (VR) Is Transforming Modern Physiotherapy",
    description:
    ...
    image:
      "https://res.cloudinary.com/dwse1tffo/image/upload/v1763908360/How_Virtual_Reality_VR_Is_Transforming_Modern_Physiotherapy_nbqvwc.jpg",
    author: "Dr. R. Varalakshmi (PT)",
    date: "2025-10-30",
    tags: ["Virtual Reality", "Neuro Rehab", "Technology", "Pain Management"],
    summary:
...
`
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dwse1tffo/image/upload/v1763908360/Why_Perfect_Posture_Is_Outdated_What_Actually_Matters_kuffty.png",
    author: "Dr. R. Varalakshmi (PT)",
    date: "2025-09-18",
    tags: ["Posture", "Spine Health", "Ergonomics", "Office Workers"],
    summary:
...
`
  ...
  {
    slug: "post-surgery-rehab-2025",
    title: "Post-Surgery Rehabilitation in 2025: Faster Recovery With Smarter Physiotherapy",
    description:
    ...
    image:
      "https://res.cloudinary.com/dwse1tffo/image/upload/v1763908269/Faster_Recovery_With_Smarter_Physio_o22u8u.jpg",
    author: "Dr. R. Varalakshmi (PT)",
    date: "2025-08-05",
    tags: ["Post-Surgery Rehab", "Orthopedics", "Recovery", "VR Rehab"],
    summary:
...
`
  ...
  {
    slug: "women-health-physio-2025",
    title: "Women’s Health Physiotherapy: Essential Updates for Every Stage of Life",
    description:
    ...
    image:
      "https://res.cloudinary.com/dwse1tffo/image/upload/v1763908825/Women_s_Health_Physiotherapy_hcvf24.jpg",
    author: "Dr. R. Varalakshmi (PT)",
    date: "2025-07-12",
    tags: ["Women’s Health", "Pelvic Floor", "Postpartum", "Menopause"],
    summary:
...
`
  ...
  {
    slug: "strength-training-physio-2025",
    title: "Why Strength Training Is Now Central to Physiotherapy Practice",
    description:
    ...
    image:
      "https://res.cloudinary.com/dwse1tffo/image/upload/v1763908824/Why_Strength_Training_Is_Now_the_Core_of_Physiotherapy_ufcnji.webp",
    author: "Dr. R. Varalakshmi (PT)",
    date: "2025-06-20",
    tags: ["Strength Training", "Rehabilitation", "Injury Prevention", "Exercise"],
    summary:
...
|------------------------|-----------------------------|
| Rest and avoidance     | Gradual exposure and loading |
| Heat and passive modalities | Individualised exercise programs |
| Short-term relief      | Long-term capacity and resilience |
